...
var creatorList = ['@rey','@reygans','@reyganteng','@reyhanganteng', '@rey','@reyganteng','@reygantengg'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'apikey invalid wa.me/6281246460730'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, wa.me/6281246460730'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'reybotz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'reybotz') return res.json(loghandler.invalidKey)
